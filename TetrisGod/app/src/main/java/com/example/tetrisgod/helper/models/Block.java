package com.example.tetrisgod.helper.models;
...
public class Block {
    private int shaleIndex;
    private int frameNumber;
    private BlockColor color;
    private Point position;

    private Block (int shaleIndex, BlockColor blockColor) {
        this.frameNumber = 0;
        this.shaleIndex = shaleIndex;
    ...
    @NonNull
        ...
        return Shape.values()[shaleIndex].getFrame(
    ...
    public  final int getFrameCount(){
        return Shape.values()[shaleIndex].getFrameCount();
    }
